...
{
    /*std::stringstream ss;
    ss << "\033[91m╔════[ Commands ]══════════════════════════════════════════════════════════════════════════╗" << ENDL;

    std::string usage = m_consoleHandler.getUsage();
    boost::replace_all(usage, "\n", "\n  ");
    usage.insert(0, "\033[91m║  \033[37m");
    ss << usage << ENDL;
...
{
    std::cout << ENDL << InformationMsg("\033[91m╔════[ Shutting Down! ]═════════════════════════════════╗\n"
                                "\033[91m║ \033[39mPlease be patient while we are shutting down the node \033[91m║\n"
                                "\033[91m╚═══════════════════════════════════════════════════════╝\n");
