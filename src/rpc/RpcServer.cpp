    ...
    const rapidjson::Document &body)
{
    ...
    const auto [publicSpendKeyRewards, publicViewKeyRewards] = Utilities::addressToKeys("VRM1JMgBTdB8hXTUwyeoa5NwUnQ93FVHy54iZYonMfm1a97543ffvnNbpFXfvEv7GgCPcuEht4knnFCkGfGWR55f47Juyc2xHY");
